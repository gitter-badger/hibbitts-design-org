...
Recently the question of how does traditional LMS usage compare to a flipped LMS approach has come up. Here are my initial thoughts so far, based on my experiences with several different LMS implementations and using the flat-file CMS [Grav](http://www.getgrav.org) in a flipped-LMS approach:
