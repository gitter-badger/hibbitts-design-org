...
One of the (many) great things about the [Grav](http://getgrav.org) CMS is that no database is required, which makes running a local copy of Grav on your computer for testing purposes a very straightforward process. This also makes deployment to a Web server a breeze - just a simple folder copy.
...
If you are curious about how a local copy of Grav can be used with GitHib/GitHub Desktop for super-easy deployments, check out my earlier article [My Dream Workflow as an Instructor](../my-dream-workflow-as-an-instructor).
