...
One of the (many) great things about the [Grav](http://getgrav.org) CMS is that no database is required, which makes running a local copy of Grav on your computer for development purposes a very straightforward process. This also makes deployment to a Web server a breeze - just a simple folder copy
